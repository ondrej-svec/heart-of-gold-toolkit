...
status: in_progress
confidence: medium
readiness: "Styled preview built and browser-verified; awaiting Ondrej's visual review; production remains out of scope"
...
- A qualified approval visibly says it will not approve and produces `needs_discussion`, `approved: false` in the simulator.
...
- [Interactive preview](https://ondrejs-mac-mini.tailbc79e3.ts.net/s/site--2026-09-13--85d53b33/); [source and reproduction notes](../previews/hog-ask-v2/README.md).
