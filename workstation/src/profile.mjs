...
export const BINDINGS = Object.freeze({
  ...
  'nvim.find-files': ['nvim/lua/plugins/snacks.lua'],
  'nvim.buffers': ['nvim/lua/plugins/snacks.lua'],
  'nvim.grep': ['nvim/lua/plugins/snacks.lua'],
  'nvim.explorer': ['nvim/lua/plugins/snacks.lua'],
  'nvim.recent': ['nvim/lua/plugins/snacks.lua'],
  'nvim.hover': ['nvim/lua/plugins/lsp-config.lua'],
  'nvim.definition': ['nvim/lua/plugins/lsp-config.lua'],
  'nvim.references': ['nvim/lua/plugins/lsp-config.lua'],
  'nvim.code-action': ['nvim/lua/plugins/lsp-config.lua'],
  'nvim.format': ['nvim/lua/plugins/lsp-config.lua'],
  'nvim.rename': ['nvim/lua/plugins/lsp-config.lua'],
  'nvim.directory': ['nvim/lua/plugins/oil.lua'],
  'nvim.navigate-panes': ['nvim/lua/plugins/nvim-tmux-navigation.lua'],
  'nvim.test-nearest': ['nvim/lua/plugins/vim-test.lua'],
  'nvim.test-file': ['nvim/lua/plugins/vim-test.lua'],
  'nvim.test-suite': ['nvim/lua/plugins/vim-test.lua'],
  'nvim.test-last': ['nvim/lua/plugins/vim-test.lua'],
  'nvim.test-visit': ['nvim/lua/plugins/vim-test.lua'],
  'tmux.split-below': ['tmux/main.conf'],
  'tmux.split-right': ['tmux/main.conf'],
  'tmux.navigate-panes': ['tmux/main.conf'],
  'tmux.new-window': ['tmux/main.conf'],
  'tmux.copy-mode-keys': ['tmux/main.conf'],
  'tmux.clipboard-paste': ['tmux/main.conf'],
  'tmux.session-picker': ['tmux/main.conf'],
});
