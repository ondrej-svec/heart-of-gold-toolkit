...
export default function hogAskExtension(pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			...
			"hog_ask submits ordinary answers directly; notes are optional before submission. Only approvals require a review step. Do not invent extra confirmation or keyboard-unlock requirements.",
